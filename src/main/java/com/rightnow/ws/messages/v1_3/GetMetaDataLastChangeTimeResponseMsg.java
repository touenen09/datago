...
/**
 * <p>GetMetaDataLastChangeTimeResponseMsg complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
...
@XmlType(name = "GetMetaDataLastChangeTimeResponseMsg", propOrder = {
    "lastChangeDateTime"
})
