...
/**
 * <p>CategoryNotificationList complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
...
public class CategoryNotificationListType {

    @XmlElement(name = "CategoryNotificationList")
    protected List<CategoryNotificationType> categoryNotificationList;
     ...
     * {@link CategoryNotificationType }
     * 
     * 
     */
    public List<CategoryNotificationType> getCategoryNotificationList() {
        if (categoryNotificationList == null) {
            categoryNotificationList = new ArrayList<CategoryNotificationType>();
        }
