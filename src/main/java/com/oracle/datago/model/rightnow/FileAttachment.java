...
@XmlType(name = "FileAttachment", namespace = "urn:objects.ws.rightnow.com/v1", propOrder = {
    "contentType",
    "createdTime",
    "data",
    "fileName",
...
public class FileAttachment {
    ...
    @XmlElementRef(name = "UpdatedTime", namespace = "urn:objects.ws.rightnow.com/v1", type = JAXBElement.class)
