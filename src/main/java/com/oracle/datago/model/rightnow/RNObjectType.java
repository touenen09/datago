...
@XmlType(name = "RNObjectType", namespace = "urn:generic.ws.rightnow.com/v1", propOrder = {
    "namespace",
    "typeName"
})
public class RNObjectType {

    @XmlElementRef(name = "Namespace", namespace = "urn:generic.ws.rightnow.com/v1", type = JAXBElement.class)
